...
loadSecretsToVault() {
  ...
  # helm chart values
  ####################
  kvault "cluster/default/bitwarden/bitwarden-helm-values.txt"
  kvault "cluster/default/blocky/blocky-helm-values.txt"
  kvault "cluster/kube-system/external-dns/external-dns-helm-values.txt"
  kvault "cluster/kube-system/kured/kured-helm-values.txt"
  kvault "cluster/kube-system/vault/vault-helm-values.txt"
  kvault "cluster/kube-system/dex/dex-helm-values.txt"
  kvault "cluster/kube-system/dex/dex-k8s-authenticator-helm-values.txt"
  kvault "cluster/kube-system/oauth2-proxy/oauth2-proxy-helm-values.txt"
  kvault "cluster/monitoring/botkube/botkube-helm-values.txt"
  kvault "cluster/monitoring/chronograf/chronograf-helm-values.txt"
  kvault "cluster/monitoring/kube-prometheus-stack/kube-prometheus-stack-helm-values.txt"
  kvault "cluster/monitoring/uptimerobot-prometheus/uptimerobot-helm-values.txt"
  kvault "cluster/monitoring/thanos/thanos-helm-values.txt"
  kvault "cluster/default/goldilocks/goldilocks-helm-values.txt"
  kvault "cluster/default/home-assistant/home-assistant-helm-values.txt"
  kvault "cluster/default/home-assistant/postgresql-helm-values.txt"
  kvault "cluster/default/minio/minio-helm-values.txt"
  ...
  kvault "cluster/velero/velero/velero-helm-values.txt"
  kvault "cluster/default/nzbhydra/nzbhydra-helm-values.txt"
